...
VALUES (current_setting('vars.first_name'), current_setting('vars.last_name'), null, current_setting('vars.email'), false, null, false, true, '{"location_id": 508635, "subscriptions": {"offers": true}}', null, null, '2019-07-16 08:32:25.000000', '2019-07-16 08:34:26.000000', null);
