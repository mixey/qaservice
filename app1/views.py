...
def create_user(request, user_type):
    ...
    try:
        ...
        if user_type == "private_phone_login":
            ...
            user_data = user_generator.private_user_with_phone_email(2)
